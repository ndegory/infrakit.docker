# REPO
REPO?=github.com/docker/infrakit.docker
...
define build_binary
	go build -o build/$(1) \
		-ldflags "-X github.com/docker/infrakit.docker/plugin.Version=$(VERSION) -X github.com/docker/infrakit.docker/plugin.Revision=$(REVISION)" $(2)
endef
...
ifneq (,$(findstring .m,$(VERSION)))
	...
	$(call build_binary,infrakit-instance-docker,github.com/docker/infrakit.docker/plugin/instance/cmd)
	#$(call build_binary,infrakit-metadata-docker,github.com/docker/infrakit.docker/plugin/metadata/cmd)
